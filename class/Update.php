...
class Update
{
    ...
    {
        global $xoopsDB;
        $sql = 'SELECT count(`candidate`) FROM ' . $xoopsDB->prefix('ancen_signup_actions') . ' ';
    ...
    {
        global $xoopsDB;
        $sql = 'ALTER TABLE ' . $xoopsDB->prefix('ancen_signup_actions') . ' ADD `candidate` tinyint(3) unsigned NOT NULL';
