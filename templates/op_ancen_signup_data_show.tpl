...
<div class="bar">
    ...
    <a href="<{$xoops_url}>/modules/ancen_signup/index.php?op=ancen_signup_data_edit&id=<{$id}>&action_id=<{$action_id}>" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i> 修改報名資料</a>
</div>
<{/if}>