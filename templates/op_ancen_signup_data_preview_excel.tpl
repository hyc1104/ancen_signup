<h2 class="my"><{$smarty.const._MD_ANCEN_SIGNUP_IMPORT}>【<{$action.title}>】<{$smarty.const._MD_ANCEN_SIGNUP_DATA_PREVIEW}></h2>
<form action="index.php" method="post" id="myForm">
    ...
    <input type="hidden" name="op" value="ancen_signup_data_import_excel">

    <div class="bar">
        <button type="submit" class="btn btn-primary">
            <i class="fa fa-save" aria-hidden="true"></i> <{$smarty.const._MD_ANCEN_SIGNUP_IMPORT}> Excel
        </button>
    </div>
</form>