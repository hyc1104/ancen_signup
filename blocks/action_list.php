        ...
        <li class='my-row'>
            ...
            <div class='my-content'>
                <select name='options[1]' class='my-input'>
                    ...
                    <option value=', `end_date` desc' " . Utility::chk($options[1], ', `end_date` desc', '', "selected") . ">活動截止日期從遠到近</option>
                    <option value=', `end_date`' " . Utility::chk($options[1], ', `end_date`', '', "selected") . ">活動截止日期從近到遠</option>
                </select>
            </div>
        </li>
    </ol>
