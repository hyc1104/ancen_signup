...
// 更新前
function xoops_module_pre_update_ancen_signup(XoopsModule $module, $old_version)
{
    // 有上傳功能才需要
    ...
    $groupid = Update::mk_group(_MI_ANCEN_SIGNUP_ADMIN);
...
// 更新後
function xoops_module_update_ancen_signup(XoopsModule $module, $old_version)
{
    global $xoopsDB;
